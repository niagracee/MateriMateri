package com.niyagrace.materimateri;
...
import com.niyagrace.materimateri.response.DataItem;
...
public class AdapterMateri extends RecyclerView.Adapter<AdapterMateri.MyViewHolder> {
    ...
    public AdapterMateri(Context context, List<DataItem> data_item) {
        // Inisialisasi
        this.context = context;
        this.materi = data_item;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        // Dapatkan url gambar
        final String urlGambarMateri = "http://192.168.20.92/portal_berita/images/" + materi.get(position).getGambar();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                varIntent.putExtra("ISI_BERITA", materi.get(position).getIsiMateri());
